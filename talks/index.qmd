...
open-graph:
  description: Selected recorded talks and invited presentations on simulation-based inference, gravitational waves, and classical gravity.
toc: true
---

Over 100 presentations at conferences, workshops, and seminars worldwide. Below is a selection of recorded talks; see my [CV](/cv/) for the full list.
...
::: {.talk-card}
[![](https://img.youtube.com/vi/mddah0yCSK8/hqdefault.jpg){.talk-thumb}](https://www.fieldsinstitute.ca/talks/Quasinormal-mode-orthogonality-and-applications)

::: {.talk-card-body}
::: {.talk-meta}
Invited Talk &middot; 2026
:::
**[Quasinormal Mode Orthogonality and Applications](https://www.fieldsinstitute.ca/talks/Quasinormal-mode-orthogonality-and-applications)**

Black Holes in General Relativity, Fields Institute
:::
:::
...
<!-- Commented out to keep the grid even (6 cards). Swap with the 2020 Capra card below if preferred.
::: {.talk-card}
...
::: {.talk-entry}
::: {.talk-meta}
Lecturer &middot; 2026
:::

### Machine Learning for Gravitational-Wave Astronomy

IMPRS for Gravity at the Extreme Joint Lecture Week, AEI
:::
