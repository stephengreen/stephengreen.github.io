...
### Metric reconstruction and self-force
...
Quasinormal modes (QNMs) describe how black holes ring down after being perturbed, but they are not orthogonal with respect to the standard Klein-Gordon inner product --- they grow exponentially toward the horizon and spatial infinity, so the usual inner product is ill-defined. With S. Hollands and P. Zimmerman, we constructed conserved currents (based on the symplectic current) for the Teukolsky equation that yield a well-defined bilinear form, and proved that QNMs of Kerr are orthogonal with respect to it [@Green:2022htq]. This provides the foundation for a perturbation theory of black holes, analogous to how normal mode orthogonality underpins quantum mechanics and other areas of wave physics.

### Applications: boson clouds and nonlinear ringdown

With E. Cannizzaro, L. Sberna, and S. Hollands, we applied this perturbation theory to compute how a massive scalar boson cloud around a Kerr black hole modifies QNM frequencies --- published in PRL [@Cannizzaro:2023jle]. Follow-up work examined the excitation of scalar QNMs from boson clouds [@Cannizzaro:2025vpb]. Separately, with L. Sberna, P. Bosch, W. East, and L. Lehner, we studied nonlinear effects in the black hole ringdown, showing that absorption of one QNM can excite others [@Sberna:2021eui].
